    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if (!empty($email) && !empty($password)) {
            ...
            if ($password === $confirmPassword) {
                ...
                mysqli_stmt_bind_param($stmt, "sssssss", $username, $fullname, $email, $hashedPassword, $confirmPassword, $address, $num);

                if (mysqli_stmt_execute($stmt)) {
                  $userId = mysqli_insert_id($con);
                    echo "<script type='text/javascript'>alert('Successfully Registered and your userId is $userId')</script>";
                } else {
